  ...
  return (
    <section className="flex flex-col md:flex-row items-stretch justify-center md:h-auto">
      ...
      lg:items-start relative justify-center lg:justify-start'>
        <div
          className='text-white text-right font-playfair font-normal leading-normal
        xl:pl-38 lg:pl-18 lg:mt-16 mt-10 mb-10 lg:mb-0 text-[24px]'
        >
        ...
        <div
          ...
          xl:right-[-15%] lg:top-[10%] lg:right-[-5%] overflow-hidden 
